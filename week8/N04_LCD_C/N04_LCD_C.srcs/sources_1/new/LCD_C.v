module LCD_C(rst,clk,LCD_E,LCD_RS,LCD_RW,LCD_DATA,LED_out,number_btn,control_btn);
        ...
        CURSOR:begin
            if(cnt==20)begin
                case(control_btn)
                    ...
                    2'b01:begin
                        if({LCD_RS,LCD_RW,LCD_DATA}==10'b0_0_0000_1111)begin  //15인 경우
                            {LCD_RS,LCD_RW,LCD_DATA}<=10'b0_0_1000_0000;//0으로 이동
                        end else if({LCD_RS,LCD_RW,LCD_DATA}==10'b0_0_0011_0111)begin  //55인 경우
                            {LCD_RS,LCD_RW,LCD_DATA}<=10'b0_0_1100_0000;//40으로 이동  
                        end else begin
