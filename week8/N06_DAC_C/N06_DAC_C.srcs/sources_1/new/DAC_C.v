module DAC_C(clk,rst,btn,add_sel,dac_csn,dac_ldacn,dac_wrn,dac_a_b,dac_d,led_out,seg_data,seg_sel,LCD_E,LCD_RS,LCD_RW,LCD_DATA);
input clk,rst;
input [5:0] btn;
input add_sel;
...
seg_array U1(clk,rst,dac_d,seg_data,seg_sel);// 7-segment array 표시
LCD U2(rst,clk,dac_d,LCD_E,LCD_RS,LCD_RW,LCD_DATA);//LCD 표시
