module text_LCD_C(rst,clk,LCD_E,LCD_RS,LCD_RW,LCD_DATA,LED_out);
...
LINE1:
    begin
        case(cnt)
            00:{LCD_RS,LCD_RW,LCD_DATA}=10'b0_0_1000_0011;//3번째 자리부터 출력
...
LINE2:
    begin
        case(cnt)
            00:{LCD_RS,LCD_RW,LCD_DATA}=10'b0_0_1100_0011;//3번째 자리부터 출력
            ...
            12:{LCD_RS,LCD_RW,LCD_DATA}=10'b1_0_0101_0011;//S
